...
#ifndef _OUT_LIRPORG_LTKC_H
#define _OUT_LIRPORG_LTKC_H
...
typedef struct LLRP_SErrorAck LLRP_tSErrorAck;

struct LLRP_SKeepalive;
typedef struct LLRP_SKeepalive LLRP_tSKeepalive;

struct LLRP_SKeepaliveAck;
typedef struct LLRP_SKeepaliveAck LLRP_tSKeepaliveAck;

struct LLRP_SDisconnect;
typedef struct LLRP_SDisconnect LLRP_tSDisconnect;

struct LLRP_SDisconnectAck;
typedef struct LLRP_SDisconnectAck LLRP_tSDisconnectAck;

struct LLRP_SDeviceEventNotification;
typedef struct LLRP_SDeviceEventNotification LLRP_tSDeviceEventNotification;

struct LLRP_SGetDeviceCapabilities;
typedef struct LLRP_SGetDeviceCapabilities LLRP_tSGetDeviceCapabilities;

struct LLRP_SGetDeviceCapabilitiesAck;
typedef struct LLRP_SGetDeviceCapabilitiesAck LLRP_tSGetDeviceCapabilitiesAck;

struct LLRP_SAddSelectSpec;
typedef struct LLRP_SAddSelectSpec LLRP_tSAddSelectSpec;

struct LLRP_SAddSelectSpecAck;
typedef struct LLRP_SAddSelectSpecAck LLRP_tSAddSelectSpecAck;

struct LLRP_SDeleteSelectSpec;
typedef struct LLRP_SDeleteSelectSpec LLRP_tSDeleteSelectSpec;

struct LLRP_SDeleteSelectSpecAck;
typedef struct LLRP_SDeleteSelectSpecAck LLRP_tSDeleteSelectSpecAck;

struct LLRP_SStartSelectSpec;
typedef struct LLRP_SStartSelectSpec LLRP_tSStartSelectSpec;

struct LLRP_SStartSelectSpecAck;
typedef struct LLRP_SStartSelectSpecAck LLRP_tSStartSelectSpecAck;

struct LLRP_SStopSelectSpec;
typedef struct LLRP_SStopSelectSpec LLRP_tSStopSelectSpec;

struct LLRP_SStopSelectSpecAck;
typedef struct LLRP_SStopSelectSpecAck LLRP_tSStopSelectSpecAck;

struct LLRP_SEnableSelectSpec;
typedef struct LLRP_SEnableSelectSpec LLRP_tSEnableSelectSpec;

struct LLRP_SEnableSelectSpecAck;
typedef struct LLRP_SEnableSelectSpecAck LLRP_tSEnableSelectSpecAck;

struct LLRP_SDisableSelectSpec;
typedef struct LLRP_SDisableSelectSpec LLRP_tSDisableSelectSpec;

struct LLRP_SDisableSelectSpecAck;
typedef struct LLRP_SDisableSelectSpecAck LLRP_tSDisableSelectSpecAck;

struct LLRP_SGetSelectSpec;
typedef struct LLRP_SGetSelectSpec LLRP_tSGetSelectSpec;

struct LLRP_SGetSelectSpecAck;
typedef struct LLRP_SGetSelectSpecAck LLRP_tSGetSelectSpecAck;

struct LLRP_SAddAccessSpec;
typedef struct LLRP_SAddAccessSpec LLRP_tSAddAccessSpec;

struct LLRP_SAddAccessSpecAck;
typedef struct LLRP_SAddAccessSpecAck LLRP_tSAddAccessSpecAck;

struct LLRP_SDeleteAccessSpec;
typedef struct LLRP_SDeleteAccessSpec LLRP_tSDeleteAccessSpec;

struct LLRP_SDeleteAccessSpecAck;
typedef struct LLRP_SDeleteAccessSpecAck LLRP_tSDeleteAccessSpecAck;

struct LLRP_SEnableAccessSpec;
typedef struct LLRP_SEnableAccessSpec LLRP_tSEnableAccessSpec;

struct LLRP_SEnableAccessSpecAck;
typedef struct LLRP_SEnableAccessSpecAck LLRP_tSEnableAccessSpecAck;

struct LLRP_SDisableAccessSpec;
typedef struct LLRP_SDisableAccessSpec LLRP_tSDisableAccessSpec;

struct LLRP_SDisableAccessSpecAck;
typedef struct LLRP_SDisableAccessSpecAck LLRP_tSDisableAccessSpecAck;

struct LLRP_SGetAccessSpec;
typedef struct LLRP_SGetAccessSpec LLRP_tSGetAccessSpec;

struct LLRP_SGetAccessSpecAck;
typedef struct LLRP_SGetAccessSpecAck LLRP_tSGetAccessSpecAck;

struct LLRP_STagSelectAccessReport;
typedef struct LLRP_STagSelectAccessReport LLRP_tSTagSelectAccessReport;

struct LLRP_SEnableCachedEventsAndReport;
typedef struct LLRP_SEnableCachedEventsAndReport LLRP_tSEnableCachedEventsAndReport;

struct LLRP_SCachedSelectAccessReport;
typedef struct LLRP_SCachedSelectAccessReport LLRP_tSCachedSelectAccessReport;

struct LLRP_SCachedSelectAccessReportAck;
typedef struct LLRP_SCachedSelectAccessReportAck LLRP_tSCachedSelectAccessReportAck;

struct LLRP_SClientRequestOp;
typedef struct LLRP_SClientRequestOp LLRP_tSClientRequestOp;

struct LLRP_SClientRequestOpAck;
typedef struct LLRP_SClientRequestOpAck LLRP_tSClientRequestOpAck;

struct LLRP_SDeviceBinding;
typedef struct LLRP_SDeviceBinding LLRP_tSDeviceBinding;

struct LLRP_SDeviceBindingAck;
typedef struct LLRP_SDeviceBindingAck LLRP_tSDeviceBindingAck;

struct LLRP_SDeviceCertificateConfig;
typedef struct LLRP_SDeviceCertificateConfig LLRP_tSDeviceCertificateConfig;

struct LLRP_SDeviceCertificateConfigAck;
typedef struct LLRP_SDeviceCertificateConfigAck LLRP_tSDeviceCertificateConfigAck;

struct LLRP_SDeviceBindingResultNotification;
typedef struct LLRP_SDeviceBindingResultNotification LLRP_tSDeviceBindingResultNotification;

struct LLRP_SUploadTagLog;
typedef struct LLRP_SUploadTagLog LLRP_tSUploadTagLog;

struct LLRP_SUploadTagLogAck;
typedef struct LLRP_SUploadTagLogAck LLRP_tSUploadTagLogAck;

struct LLRP_SUploadTagLogConfirm;
typedef struct LLRP_SUploadTagLogConfirm LLRP_tSUploadTagLogConfirm;

struct LLRP_SClearTagLog;
typedef struct LLRP_SClearTagLog LLRP_tSClearTagLog;

struct LLRP_SClearTagLogAck;
typedef struct LLRP_SClearTagLogAck LLRP_tSClearTagLogAck;

struct LLRP_STagLogCount;
typedef struct LLRP_STagLogCount LLRP_tSTagLogCount;

struct LLRP_STagLogCountAck;
typedef struct LLRP_STagLogCountAck LLRP_tSTagLogCountAck;

struct LLRP_SUploadDeviceLog;
typedef struct LLRP_SUploadDeviceLog LLRP_tSUploadDeviceLog;

struct LLRP_SUploadDeviceLogAck;
typedef struct LLRP_SUploadDeviceLogAck LLRP_tSUploadDeviceLogAck;

struct LLRP_SUploadDeviceLogConfirm;
typedef struct LLRP_SUploadDeviceLogConfirm LLRP_tSUploadDeviceLogConfirm;

struct LLRP_SDeviceLogCount;
typedef struct LLRP_SDeviceLogCount LLRP_tSDeviceLogCount;

struct LLRP_SDeviceLogCountAck;
typedef struct LLRP_SDeviceLogCountAck LLRP_tSDeviceLogCountAck;

struct LLRP_SClearDeviceLog;
typedef struct LLRP_SClearDeviceLog LLRP_tSClearDeviceLog;

struct LLRP_SClearDeviceLogAck;
typedef struct LLRP_SClearDeviceLogAck LLRP_tSClearDeviceLogAck;

struct LLRP_SGetDeviceConfig;
typedef struct LLRP_SGetDeviceConfig LLRP_tSGetDeviceConfig;

struct LLRP_SGetDeviceConfigAck;
typedef struct LLRP_SGetDeviceConfigAck LLRP_tSGetDeviceConfigAck;

struct LLRP_SSetDeviceConfig;
typedef struct LLRP_SSetDeviceConfig LLRP_tSSetDeviceConfig;

struct LLRP_SSetDeviceConfigAck;
typedef struct LLRP_SSetDeviceConfigAck LLRP_tSSetDeviceConfigAck;

struct LLRP_SGetVersion;
typedef struct LLRP_SGetVersion LLRP_tSGetVersion;

struct LLRP_SGetVersionAck;
typedef struct LLRP_SGetVersionAck LLRP_tSGetVersionAck;

struct LLRP_SSetVersion;
typedef struct LLRP_SSetVersion LLRP_tSSetVersion;

struct LLRP_SSetVersionAck;
typedef struct LLRP_SSetVersionAck LLRP_tSSetVersionAck;

struct LLRP_SActiveVersion;
typedef struct LLRP_SActiveVersion LLRP_tSActiveVersion;

struct LLRP_SActiveVersionAck;
typedef struct LLRP_SActiveVersionAck LLRP_tSActiveVersionAck;

struct LLRP_SUnActiveVersion;
typedef struct LLRP_SUnActiveVersion LLRP_tSUnActiveVersion;

struct LLRP_SUnActiveVersionAck;
typedef struct LLRP_SUnActiveVersionAck LLRP_tSUnActiveVersionAck;

struct LLRP_SAlarmReport;
typedef struct LLRP_SAlarmReport LLRP_tSAlarmReport;

struct LLRP_SAlarmRestore;
typedef struct LLRP_SAlarmRestore LLRP_tSAlarmRestore;

struct LLRP_SAlarmDelete;
typedef struct LLRP_SAlarmDelete LLRP_tSAlarmDelete;

struct LLRP_SAlarmSync;
typedef struct LLRP_SAlarmSync LLRP_tSAlarmSync;

struct LLRP_SDiagnosticTest;
typedef struct LLRP_SDiagnosticTest LLRP_tSDiagnosticTest;

struct LLRP_SDiagnosticTestAck;
typedef struct LLRP_SDiagnosticTestAck LLRP_tSDiagnosticTestAck;

struct LLRP_SResetDevice;
typedef struct LLRP_SResetDevice LLRP_tSResetDevice;

struct LLRP_SResetDeviceAck;
typedef struct LLRP_SResetDeviceAck LLRP_tSResetDeviceAck;
...
struct LLRP_SStatus;
typedef struct LLRP_SStatus LLRP_tSStatus;

struct LLRP_SUTCTimestamp;
typedef struct LLRP_SUTCTimestamp LLRP_tSUTCTimestamp;

struct LLRP_SGPIEvent;
typedef struct LLRP_SGPIEvent LLRP_tSGPIEvent;

struct LLRP_SSelectSpecEvent;
typedef struct LLRP_SSelectSpecEvent LLRP_tSSelectSpecEvent;

struct LLRP_SAntennaSpecEvent;
typedef struct LLRP_SAntennaSpecEvent LLRP_tSAntennaSpecEvent;

struct LLRP_SAntennaStatusEvent;
typedef struct LLRP_SAntennaStatusEvent LLRP_tSAntennaStatusEvent;

struct LLRP_SConnectionAttemptEvent;
typedef struct LLRP_SConnectionAttemptEvent LLRP_tSConnectionAttemptEvent;

struct LLRP_SGenaralCapabilities;
typedef struct LLRP_SGenaralCapabilities LLRP_tSGenaralCapabilities;

struct LLRP_SGPIOCapabilities;
typedef struct LLRP_SGPIOCapabilities LLRP_tSGPIOCapabilities;

struct LLRP_SCommunicationCapabilities;
typedef struct LLRP_SCommunicationCapabilities LLRP_tSCommunicationCapabilities;

struct LLRP_SSupportRS232;
typedef struct LLRP_SSupportRS232 LLRP_tSSupportRS232;

struct LLRP_SSerialAttribute;
typedef struct LLRP_SSerialAttribute LLRP_tSSerialAttribute;

struct LLRP_SSupportRS485;
typedef struct LLRP_SSupportRS485 LLRP_tSSupportRS485;

struct LLRP_SSpecCapabilities;
typedef struct LLRP_SSpecCapabilities LLRP_tSSpecCapabilities;

struct LLRP_SRfCapabilities;
typedef struct LLRP_SRfCapabilities LLRP_tSRfCapabilities;

struct LLRP_STransmitPowerLevelTable;
typedef struct LLRP_STransmitPowerLevelTable LLRP_tSTransmitPowerLevelTable;

struct LLRP_SFrequencyInformation;
typedef struct LLRP_SFrequencyInformation LLRP_tSFrequencyInformation;

struct LLRP_SFrequencyTable;
typedef struct LLRP_SFrequencyTable LLRP_tSFrequencyTable;

struct LLRP_SForDataRateTable;
typedef struct LLRP_SForDataRateTable LLRP_tSForDataRateTable;

struct LLRP_SRevDataRateTable;
typedef struct LLRP_SRevDataRateTable LLRP_tSRevDataRateTable;

struct LLRP_SForModulationTable;
typedef struct LLRP_SForModulationTable LLRP_tSForModulationTable;

struct LLRP_SRevDataEncodingTable;
typedef struct LLRP_SRevDataEncodingTable LLRP_tSRevDataEncodingTable;

struct LLRP_SModuleDepthTable;
typedef struct LLRP_SModuleDepthTable LLRP_tSModuleDepthTable;

struct LLRP_SAirProtocolCapabilities;
typedef struct LLRP_SAirProtocolCapabilities LLRP_tSAirProtocolCapabilities;

struct LLRP_SPerAntennaAirProtocol;
typedef struct LLRP_SPerAntennaAirProtocol LLRP_tSPerAntennaAirProtocol;

struct LLRP_SHbProtocolCapabilities;
typedef struct LLRP_SHbProtocolCapabilities LLRP_tSHbProtocolCapabilities;

struct LLRP_SSelectSpec;
typedef struct LLRP_SSelectSpec LLRP_tSSelectSpec;

struct LLRP_SSelectSpecStartTrigger;
typedef struct LLRP_SSelectSpecStartTrigger LLRP_tSSelectSpecStartTrigger;

struct LLRP_SPeriodicTrigger;
typedef struct LLRP_SPeriodicTrigger LLRP_tSPeriodicTrigger;

struct LLRP_SGPITrigger;
typedef struct LLRP_SGPITrigger LLRP_tSGPITrigger;

struct LLRP_SSelectSpecStopTrigger;
typedef struct LLRP_SSelectSpecStopTrigger LLRP_tSSelectSpecStopTrigger;

struct LLRP_SAntennaSpec;
typedef struct LLRP_SAntennaSpec LLRP_tSAntennaSpec;

struct LLRP_SAntennaSpecStopTrigger;
typedef struct LLRP_SAntennaSpecStopTrigger LLRP_tSAntennaSpecStopTrigger;

struct LLRP_STagObservationTrigger;
typedef struct LLRP_STagObservationTrigger LLRP_tSTagObservationTrigger;

struct LLRP_SRfSpec;
typedef struct LLRP_SRfSpec LLRP_tSRfSpec;

struct LLRP_SMemoryBank;
typedef struct LLRP_SMemoryBank LLRP_tSMemoryBank;

struct LLRP_SSelectReportSpec;
typedef struct LLRP_SSelectReportSpec LLRP_tSSelectReportSpec;

struct LLRP_SReportDestination;
typedef struct LLRP_SReportDestination LLRP_tSReportDestination;

struct LLRP_SAccessSpec;
typedef struct LLRP_SAccessSpec LLRP_tSAccessSpec;

struct LLRP_SAccessSpecStopTrigger;
typedef struct LLRP_SAccessSpecStopTrigger LLRP_tSAccessSpecStopTrigger;

struct LLRP_SAccessCommand;
typedef struct LLRP_SAccessCommand LLRP_tSAccessCommand;

struct LLRP_SSecurityModuleSpec;
typedef struct LLRP_SSecurityModuleSpec LLRP_tSSecurityModuleSpec;

struct LLRP_SHbMatchSpec;
typedef struct LLRP_SHbMatchSpec LLRP_tSHbMatchSpec;

struct LLRP_SHbTargetTag;
typedef struct LLRP_SHbTargetTag LLRP_tSHbTargetTag;

struct LLRP_SHbReadSpec;
typedef struct LLRP_SHbReadSpec LLRP_tSHbReadSpec;

struct LLRP_SClientRequestSpec;
typedef struct LLRP_SClientRequestSpec LLRP_tSClientRequestSpec;

struct LLRP_SAccessReportSpec;
typedef struct LLRP_SAccessReportSpec LLRP_tSAccessReportSpec;

struct LLRP_SHbWriteSpec;
typedef struct LLRP_SHbWriteSpec LLRP_tSHbWriteSpec;

struct LLRP_SHbPrivateWriteSpec;
typedef struct LLRP_SHbPrivateWriteSpec LLRP_tSHbPrivateWriteSpec;

struct LLRP_STagReportData;
typedef struct LLRP_STagReportData LLRP_tSTagReportData;

struct LLRP_SSelectSpecID;
typedef struct LLRP_SSelectSpecID LLRP_tSSelectSpecID;

struct LLRP_SSpecIndex;
typedef struct LLRP_SSpecIndex LLRP_tSSpecIndex;

struct LLRP_SRfSpecID;
typedef struct LLRP_SRfSpecID LLRP_tSRfSpecID;

struct LLRP_SAntennaID;
typedef struct LLRP_SAntennaID LLRP_tSAntennaID;

struct LLRP_SPeakRSSI;
typedef struct LLRP_SPeakRSSI LLRP_tSPeakRSSI;

struct LLRP_SFirstSeenTimestampUTC;
typedef struct LLRP_SFirstSeenTimestampUTC LLRP_tSFirstSeenTimestampUTC;

struct LLRP_SLastSeenTimestampUTC;
typedef struct LLRP_SLastSeenTimestampUTC LLRP_tSLastSeenTimestampUTC;

struct LLRP_STagSeenCount;
typedef struct LLRP_STagSeenCount LLRP_tSTagSeenCount;

struct LLRP_SAccessSpecID;
typedef struct LLRP_SAccessSpecID LLRP_tSAccessSpecID;

struct LLRP_SGenaralSelectSpecResult;
typedef struct LLRP_SGenaralSelectSpecResult LLRP_tSGenaralSelectSpecResult;

struct LLRP_SCustomizedSelectSpecResult;
typedef struct LLRP_SCustomizedSelectSpecResult LLRP_tSCustomizedSelectSpecResult;

struct LLRP_SHbReadSpecResult;
typedef struct LLRP_SHbReadSpecResult LLRP_tSHbReadSpecResult;

struct LLRP_SClientRequestSpecResult;
typedef struct LLRP_SClientRequestSpecResult LLRP_tSClientRequestSpecResult;

struct LLRP_SHbWriteSpecResult;
typedef struct LLRP_SHbWriteSpecResult LLRP_tSHbWriteSpecResult;

struct LLRP_SHbPrivateWriteSpecResult;
typedef struct LLRP_SHbPrivateWriteSpecResult LLRP_tSHbPrivateWriteSpecResult;

struct LLRP_SHbCustomizedReadSpecResult;
typedef struct LLRP_SHbCustomizedReadSpecResult LLRP_tSHbCustomizedReadSpecResult;

struct LLRP_SReadDataInfo;
typedef struct LLRP_SReadDataInfo LLRP_tSReadDataInfo;

struct LLRP_SCID;
typedef struct LLRP_SCID LLRP_tSCID;

struct LLRP_SFPDH;
typedef struct LLRP_SFPDH LLRP_tSFPDH;

struct LLRP_SSYXZ;
typedef struct LLRP_SSYXZ LLRP_tSSYXZ;

struct LLRP_SCCRQ;
typedef struct LLRP_SCCRQ LLRP_tSCCRQ;

struct LLRP_SCLLX;
typedef struct LLRP_SCLLX LLRP_tSCLLX;

struct LLRP_SGL;
typedef struct LLRP_SGL LLRP_tSGL;

struct LLRP_SPL;
typedef struct LLRP_SPL LLRP_tSPL;

struct LLRP_SHPZL;
typedef struct LLRP_SHPZL LLRP_tSHPZL;

struct LLRP_SHPHMXH;
typedef struct LLRP_SHPHMXH LLRP_tSHPHMXH;

struct LLRP_SJYYXQ;
typedef struct LLRP_SJYYXQ LLRP_tSJYYXQ;

struct LLRP_SQZBFQ;
typedef struct LLRP_SQZBFQ LLRP_tSQZBFQ;

struct LLRP_SZKZL;
typedef struct LLRP_SZKZL LLRP_tSZKZL;

struct LLRP_SCSYS;
typedef struct LLRP_SCSYS LLRP_tSCSYS;

struct LLRP_SClientRequestAck;
typedef struct LLRP_SClientRequestAck LLRP_tSClientRequestAck;

struct LLRP_STagLog;
typedef struct LLRP_STagLog LLRP_tSTagLog;

struct LLRP_SStartLogTimestamp;
typedef struct LLRP_SStartLogTimestamp LLRP_tSStartLogTimestamp;

struct LLRP_SEndLogTimestamp;
typedef struct LLRP_SEndLogTimestamp LLRP_tSEndLogTimestamp;

struct LLRP_SDeviceLog;
typedef struct LLRP_SDeviceLog LLRP_tSDeviceLog;

struct LLRP_SDeviceEventNotificationSpec;
typedef struct LLRP_SDeviceEventNotificationSpec LLRP_tSDeviceEventNotificationSpec;

struct LLRP_SEventNotificationState;
typedef struct LLRP_SEventNotificationState LLRP_tSEventNotificationState;

struct LLRP_SAntennaProperties;
typedef struct LLRP_SAntennaProperties LLRP_tSAntennaProperties;

struct LLRP_SAntennaConfiguration;
typedef struct LLRP_SAntennaConfiguration LLRP_tSAntennaConfiguration;

struct LLRP_SModuleDepth;
typedef struct LLRP_SModuleDepth LLRP_tSModuleDepth;

struct LLRP_SIdentification;
typedef struct LLRP_SIdentification LLRP_tSIdentification;

struct LLRP_SAlarmConfiguration;
typedef struct LLRP_SAlarmConfiguration LLRP_tSAlarmConfiguration;

struct LLRP_SAlarmThreshod;
typedef struct LLRP_SAlarmThreshod LLRP_tSAlarmThreshod;

struct LLRP_SCommunicationConfiguration;
typedef struct LLRP_SCommunicationConfiguration LLRP_tSCommunicationConfiguration;

struct LLRP_SCommLinkConfiguration;
typedef struct LLRP_SCommLinkConfiguration LLRP_tSCommLinkConfiguration;

struct LLRP_SKeepaliveSpec;
typedef struct LLRP_SKeepaliveSpec LLRP_tSKeepaliveSpec;

struct LLRP_STcpLinkConfiguration;
typedef struct LLRP_STcpLinkConfiguration LLRP_tSTcpLinkConfiguration;

struct LLRP_SClientModeConfiguration;
typedef struct LLRP_SClientModeConfiguration LLRP_tSClientModeConfiguration;

struct LLRP_SIPAddress;
typedef struct LLRP_SIPAddress LLRP_tSIPAddress;

struct LLRP_SServerModeConfiguration;
typedef struct LLRP_SServerModeConfiguration LLRP_tSServerModeConfiguration;

struct LLRP_SSerialLinkConfiguration;
typedef struct LLRP_SSerialLinkConfiguration LLRP_tSSerialLinkConfiguration;

struct LLRP_SHttpLinkConfiguration;
typedef struct LLRP_SHttpLinkConfiguration LLRP_tSHttpLinkConfiguration;

struct LLRP_SEthernetIpv4Configuration;
typedef struct LLRP_SEthernetIpv4Configuration LLRP_tSEthernetIpv4Configuration;

struct LLRP_SEthernetIpv6Configuration;
typedef struct LLRP_SEthernetIpv6Configuration LLRP_tSEthernetIpv6Configuration;

struct LLRP_SNTPConfiguration;
typedef struct LLRP_SNTPConfiguration LLRP_tSNTPConfiguration;

struct LLRP_SSerialPortConfiguration;
typedef struct LLRP_SSerialPortConfiguration LLRP_tSSerialPortConfiguration;

struct LLRP_SLocationConfiguration;
typedef struct LLRP_SLocationConfiguration LLRP_tSLocationConfiguration;

struct LLRP_SGpsLocation;
typedef struct LLRP_SGpsLocation LLRP_tSGpsLocation;

struct LLRP_SBdsLocation;
typedef struct LLRP_SBdsLocation LLRP_tSBdsLocation;

struct LLRP_SSecurityModuleConfiguration;
typedef struct LLRP_SSecurityModuleConfiguration LLRP_tSSecurityModuleConfiguration;

struct LLRP_SGenaralConfigData;
typedef struct LLRP_SGenaralConfigData LLRP_tSGenaralConfigData;

struct LLRP_SRTCTime;
typedef struct LLRP_SRTCTime LLRP_tSRTCTime;

struct LLRP_SSecurityModuleSN;
typedef struct LLRP_SSecurityModuleSN LLRP_tSSecurityModuleSN;

struct LLRP_SReadMode;
typedef struct LLRP_SReadMode LLRP_tSReadMode;

struct LLRP_SPrivateConfigData;
typedef struct LLRP_SPrivateConfigData LLRP_tSPrivateConfigData;

struct LLRP_SVersionInfo;
typedef struct LLRP_SVersionInfo LLRP_tSVersionInfo;

struct LLRP_SVersionDownload;
typedef struct LLRP_SVersionDownload LLRP_tSVersionDownload;

struct LLRP_SAlarmReportInfo;
typedef struct LLRP_SAlarmReportInfo LLRP_tSAlarmReportInfo;

struct LLRP_SAlarmRestoreInfo;
typedef struct LLRP_SAlarmRestoreInfo LLRP_tSAlarmRestoreInfo;

struct LLRP_SAlarmSyncInfo;
typedef struct LLRP_SAlarmSyncInfo LLRP_tSAlarmSyncInfo;

struct LLRP_SDiagnosticTestItem;
typedef struct LLRP_SDiagnosticTestItem LLRP_tSDiagnosticTestItem;

struct LLRP_SDiagnosticTestResultItem;
typedef struct LLRP_SDiagnosticTestResultItem LLRP_tSDiagnosticTestResultItem;

struct LLRP_SDiagnosticTestResultAntennaConnected;
typedef struct LLRP_SDiagnosticTestResultAntennaConnected LLRP_tSDiagnosticTestResultAntennaConnected;

struct LLRP_SDiagnosticTestResultAntennaVSWR;
typedef struct LLRP_SDiagnosticTestResultAntennaVSWR LLRP_tSDiagnosticTestResultAntennaVSWR;
...
typedef enum LLRP_EGPIEventType LLRP_tEGPIEventType;
...
typedef enum LLRP_ESelectSpecEventType LLRP_tESelectSpecEventType;
...
typedef enum LLRP_EAntennaSpecEventType LLRP_tEAntennaSpecEventType;
...
typedef enum LLRP_EAntennaStatusEventType LLRP_tEAntennaStatusEventType;
...
typedef enum LLRP_EConnectionAttemptEventStatusType LLRP_tEConnectionAttemptEventStatusType;
...
typedef enum LLRP_EGetDeviceCapabilitiesRequestedDataType LLRP_tEGetDeviceCapabilitiesRequestedDataType;
...
typedef enum LLRP_EForModulationType LLRP_tEForModulationType;
...
typedef enum LLRP_ERevDataEncodingType LLRP_tERevDataEncodingType;
...
typedef enum LLRP_ESelectSpecState LLRP_tESelectSpecState;
...
typedef enum LLRP_ESelectSpecStartTriggerType LLRP_tESelectSpecStartTriggerType;
...
typedef enum LLRP_ESelectSpecStopTriggerType LLRP_tESelectSpecStopTriggerType;
...
enum LLRP_EAntennaSpecStopTriggerType
{
    ...
    LLRP_AntennaSpecStopTriggerType_GPI = 2,
    LLRP_AntennaSpecStopTriggerType_Tag_Observation = 3,
};

typedef enum LLRP_EAntennaSpecStopTriggerType LLRP_tEAntennaSpecStopTriggerType;
...
typedef enum LLRP_ETagObservationTriggerType LLRP_tETagObservationTriggerType;
...
typedef enum LLRP_EAirProtocolType LLRP_tEAirProtocolType;
...
typedef enum LLRP_ERfSpecSelectType LLRP_tERfSpecSelectType;
...
typedef enum LLRP_EHbReadType LLRP_tEHbReadType;
...
typedef enum LLRP_EHbBankType LLRP_tEHbBankType;
...
enum LLRP_ESelectReportTriggerType
{
    ...
    LLRP_SelectReportTriggerType_No_SelectReport = 3,
};

typedef enum LLRP_ESelectReportTriggerType LLRP_tESelectReportTriggerType;
...
typedef enum LLRP_EAccessSpecState LLRP_tEAccessSpecState;
...
typedef enum LLRP_EAccessSpecStopTriggerType LLRP_tEAccessSpecStopTriggerType;
...
typedef enum LLRP_EHbTargetTagMemoryType LLRP_tEHbTargetTagMemoryType;
...
typedef enum LLRP_EHbTargetTagMatchType LLRP_tEHbTargetTagMatchType;
...
typedef enum LLRP_EHbSpecMemoryBankIDType LLRP_tEHbSpecMemoryBankIDType;
...
typedef enum LLRP_EAccessReportTriggerType LLRP_tEAccessReportTriggerType;
...
typedef enum LLRP_EEnumIsLastedFrame LLRP_tEEnumIsLastedFrame;
...
typedef enum LLRP_EDeviceBindingType LLRP_tEDeviceBindingType;
...
typedef enum LLRP_EUploadTagLogType LLRP_tEUploadTagLogType;
...
typedef enum LLRP_EUploadDeviceLogType LLRP_tEUploadDeviceLogType;
...
typedef enum LLRP_EDeviceLogType LLRP_tEDeviceLogType;
...
typedef enum LLRP_EGetDeviceConfigRequestedDataType LLRP_tEGetDeviceConfigRequestedDataType;
...
typedef enum LLRP_EEventNotificationType LLRP_tEEventNotificationType;
...
typedef enum LLRP_ECommLinkType LLRP_tECommLinkType;
...
typedef enum LLRP_EKeepaliveTriggerType LLRP_tEKeepaliveTriggerType;
...
typedef enum LLRP_ETcpLinkCommMode LLRP_tETcpLinkCommMode;
...
typedef enum LLRP_EIPAddressVersion LLRP_tEIPAddressVersion;
...
typedef enum LLRP_EReaderLocationType LLRP_tEReaderLocationType;
...
typedef enum LLRP_EVersionType LLRP_tEVersionType;
...
typedef enum LLRP_EVersionDownloadServerType LLRP_tEVersionDownloadServerType;
...
typedef enum LLRP_EAlarmReportLevel LLRP_tEAlarmReportLevel;
...
typedef enum LLRP_EAlarmRestoreType LLRP_tEAlarmRestoreType;
...
void
LLRP_enrollLIRPOrgTypesIntoRegistry (
